...
require_relative 'shared/values_at_spec'
...
describe 'DataMapper::SubjectSet#values_at' do
  ...
  context 'when one name is given and no entry with the given name is present' do
    ...
    it_behaves_like 'DataMapper::SubjectSet#values_at when one name is given and no entry with the given name is present'
  end
  ...
  context 'when one name is given and an entry with the given name is present' do
    ...
    it_behaves_like 'DataMapper::SubjectSet#values_at when one name is given and an entry with the given name is present'
  end
  ...
  context 'when more than one name is given and no entry with any of the given names is present' do
    ...
    it_behaves_like 'DataMapper::SubjectSet#values_at when more than one name is given and no entry with any of the given names is present'
  end
  ...
  context 'when more than one name is given and one entry with one of the given names is present' do
    ...
    it_behaves_like 'DataMapper::SubjectSet#values_at when more than one name is given and one entry with one of the given names is present'
  end
  ...
  context 'when more than one name is given and an entry for every given name is present' do
    ...
    it_behaves_like 'DataMapper::SubjectSet#values_at when more than one name is given and an entry for every given name is present'
  end
end
